...
from maskrcnn_benchmark.engine.trainer_1 import do_da_train_meta_maml
...
def train_meta(cfg, local_rank, distributed):
    ...
    meta_model = _init_params(meta_model)
    ...
    optimizer = make_optimizer_inner(cfg, model,cfg.SOLVER.INNER_LR)
