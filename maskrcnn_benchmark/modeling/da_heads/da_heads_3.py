...
class DAImgHead(nn.Module):
    ...
    def __init__(self, is_retina):
        ...
        if is_retina:
            in_channels_block = [1024,1024,1024]
        else:
...
class DomainAdaptationModule(torch.nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.imghead = DAImgHead(self.retina)
    ...
    def forward(self, img_features, da_ins_feature, da_ins_labels, da_proposals,targets=None):
        ...
        """
        if self.resnet_backbone and not self.retina:
        ...
        if self.retina:
            ...
            if self.training:
                da_img_loss, da_ins_loss, da_consistency_loss = self.loss_evaluator(
                    da_proposals,da_img_features, None, None, None, None, targets
                )
                losses = {}
